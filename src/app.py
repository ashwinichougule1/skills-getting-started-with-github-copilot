...
activities = {
    ...
    "Soccer Team": {
        "description": "Competitive team sport practice and matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["sarah@mergington.edu", "matt@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Basketball training sessions and friendly games",
    ...
    "Drama Club": {
        "description": "Rehearse plays, improv, and stage performance skills",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["ethan@mergington.edu", "mia@mergington.edu"]
    },
    "Robotics Workshop": {
        "description": "Build robots and learn about engineering challenges",
